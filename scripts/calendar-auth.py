#!/usr/bin/env python3
"""
One-time OAuth flow for Google Calendar API.
...
to data/.calendar-tokens.json.

Usage:
    python3 scripts/calendar-auth.py --client-id CLIENT_ID --client-secret CLIENT_SECRET
...
def main():
    parser = argparse.ArgumentParser(description="Google Calendar OAuth flow")
    ...
    output_path = os.path.join(repo_root, "data", ".calendar-tokens.json")
    ...
    print("   ./scripts/calendar-setup.sh")
    print()
